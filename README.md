...
| [Detecting Phones](https://github.com/Jswig/bctakehome)| Computer vision project I used to learn OpenCV I which I implemented an algorithm that detects phones on floors| Python (OpenCV)
