...
| Project | Description |
| --- | --- |
| [Intersection Congestion Prediction](https://github.com/Jswig/bq-geotab)| Kaggle competition where I used bayesian hyperparamter optimization to tune a tensorflow boosted trees model|
